...
const Mina = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      > {t('La mina La Diamantina es una de las concesiónes mineras de piedras de afilar argentina otorgada por la Dirección General de Minería de la Nación.')}
      ...
      <div className="flex items-center mb-4">
        ...
        >
           {t('Se encuentra a 120 Km de la ciudad de San Rafael Mendoza Argentina, en el distrito minero Nº 11, con una superficie de 18 Has.')}
      ...
      <div className="flex items-center mb-4">
        ...
        >
           {t('Título de propiedad de Fojas 120 y 121, todo ello referido al expediente 4P-81, certificados Nº 60936 de Dirección General de Minería de la Nación.')}
      ...
      >{t('Certificado de mensura y posesiones, al asiento 876, Folio 98 del Tomo 8 del registro de mensuras y posesiones.')}
