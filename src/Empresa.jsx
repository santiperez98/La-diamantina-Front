  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      >
        ...
        {t('LA DIAMANTINA es una empresa familiar fundada por José Pérez y continuada por sus herederos, Miguel A. Pérez y Elbio Ramiro Pérez (Hijo y nieto de don José).')}
      </p>
      ...
      >
        ...
        {t('El yacimiento propio explotado desde hace 82 años por su fundador es hoy producido por la familia, quien en forma continua hasta estos días y con dedicación exclusiva a esta actividad minera e industrial, extraen y manufacturan en planta industrial propia, desarrollando el ciclo completo de producción y venta de una completa línea de piedras de afilar de alta calidad al mejor precio.')}
      </p>
      ...
      >
        ...
        {t('Se encuentra en Ortiz de Rosas 1227 de San Rafael, Mendoza a 20 cuadras del km 0, cuenta con una superficie de 2.400 m2 en donde se procesa el mineral extraído de la mina LA DIAMANTINA.')}
      </p>
      ...
      >
        ...
        {t('El mineral es tratado, de acuerdo a su utilidad y destino, con seis tipos de cortadoras de discos diamantados y pulidoras de esmeril para una correcta terminación.')}
      </p>

      <p className={`text-lg mb-4 transition-opacity duration-700 delay-700 ${plantInView ? 'opacity-100' : 'opacity-0'}`}>

        {t('La empresa cuenta con galpones de almacenamiento y línea de etiquetado, pasando en todas sus etapas de manufactura por estrictos controles de calidad que permiten ofrecer garantía de fabricación al usuario.')}
      </p>

      {/* Sección de Fundación */}
      <h2 className="text-2xl font-bold my-4">
      {t('Fundación de la Empresa')}
      </h2>
      <div
        ref={fundRef}
      ...
      >
        ...
        {t('LA DIAMANTINA fue fundada en 1942 por José Pérez, quien visionó la posibilidad de extraer y manufacturar piedras de afilar de alta calidad. Desde sus inicios, la empresa se ha enfocado en la innovación y en mantener altos estándares de calidad en sus productos. Con el pasar de los años, la empresa ha sido liderada por su familia, continuando con el legado de dedicación y compromiso que estableció su fundador.')}
          
        </p>
        <p className="text-lg mb-4">
          <FontAwesomeIcon icon={faChevronRight} className="text-[#c2ac93] mr-2" />
          {t('Visita nuestra sección de productos para ver la variedad que ofrecemos.')}
